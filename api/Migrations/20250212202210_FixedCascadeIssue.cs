        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nutrition_Calories = table.Column<int>(type: "int", nullable: true),
                    Nutrition_Carbohydrates = table.Column<int>(type: "int", nullable: true),
                    Nutrition_Protein = table.Column<int>(type: "int", nullable: true),
                    Nutrition_Fat = table.Column<int>(type: "int", nullable: true),
                    UserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CookbookRecipes", x => new { x.CookbookId, x.RecipesId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CookbookRecipes_Recipes_RecipesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserSavedRecipes", x => new { x.RecipeId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CookbookRecipes_RecipesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSavedRecipes_UserId",
